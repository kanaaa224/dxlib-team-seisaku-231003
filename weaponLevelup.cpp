...
void WeaponLevelUp::DrawWeaponImages() const
{
	...
	case sword:			// 片手剣
		...
		{
			 DrawRotaGraph(img_x, img_y, 0.2f, 0.0f, img_legendsword, TRUE);
		}
		else if (weapon1_info.level == 8)
		{
			 DrawRotaGraph(img_x, img_y, 0.17f, 0.0f, img_magicsword, TRUE);
		}
		else
		{
	...
	case greatSword:	// 大剣
		if (weapon1_info.level == 7)
		{
			 DrawRotaGraph(img_x, img_y, 0.2f, 0.0f, img_windslash, TRUE);
		}
		else if (weapon1_info.level == 8)
		{
			 DrawRotaGraph(img_x, img_y, 0.2f, 0.0f, img_dustsword, TRUE);
		}
		else
		{
	...
	case spear:			// 槍
		...
		{
			 DrawRotaGraph(img_x + 380, img_y, 0.2f, 0.0f, img_royallance, TRUE);
		}
		else if (weapon2_info.level == 8)
		{
			 DrawRotaGraph(img_x + 380, img_y, 0.21f, 0.0f, img_gungnir, TRUE);
		}
		else
		{
	...
	case book:			// 本
		if (weapon2_info.level == 7)
		{
			 DrawRotaGraph(img_x + 380, img_y, 0.12f, 0.0f, img_blessing, TRUE);
		}
		else if (weapon2_info.level == 8)
		{
			 DrawRotaGraph(img_x + 380, img_y - 5, 0.24f, 0.0f, img_bullet, TRUE);
		}
		else
		{
			DrawRotaGraph(img_x + 380, img_y, 0.12f, 0.0f, img_book, TRUE);
		}
		break;
	default:
