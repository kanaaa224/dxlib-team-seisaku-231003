...
void ResultScene::draw() const
{
	...
	{
	case 0:			// 片手剣
		DrawRotaGraph(750, 250, 0.2f, 0.0f, img_sword, TRUE);
		DrawFormatString(850, 150, 0x000000, "片手剣");
		break;
	case 1:		// 短剣
		DrawRotaGraph(1000, 300, 0.4f, 0.0f, img_dagger, TRUE);
		DrawFormatString(250, 530, 0x000000, "短剣");
		break;
	case 2:	// 大剣
		DrawRotaGraph(1000, 300, 0.4f, 0.0f, img_great_sword, TRUE);
		DrawFormatString(250, 530, 0x000000, "大剣");
		break;
	default:
		DrawRotaGraph(1000, 300, 0.2f, 0.0f, img_question_mark, TRUE);
