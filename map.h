...
private:
	...
	const int icon_loc_def[PATTERN_MAX][DATA_MAX][2] = { {
		...
		{500, 620}, {750, 620}, {500, 530}, {750, 530}, {450, 440},
		{550, 440}, {700, 440}, {800, 440}, {630, 330}, {500, 230},
		{750, 230}, {450, 130}, {550, 130}, {700, 130}, {800, 130},
		{500, 40}, {750, 40}, {500, -60}, {750, -60}, {630, -170},
		{630, -270},
	} };
	...
	const int next_stage[PATTERN_MAX][DATA_MAX][3]{ {
			...
			{2,-1,-1},{3,-1,-1},{4,5,-1},{6,7,-1},{8,-1,-1},
			{8,-1,-1},{8,-1,-1},{8,-1,-1},{9,10,-1},{11,12,-1},{13,14,-1},
			{15,-1,-1},{15,-1,-1},{16,-1,-1},{16,-1,-1},{17,-1,-1},
			{18,-1,-1},{19,-1,-1},{19,-1,-1},{20,-1,-1},
			{0,1,-1}
		},
	};
	int stage_log[10];
	...
	int battle_font_img = 0;
	int event_font_img = 0;
	int rest_font_img = 0;
	int anvil_font_img = 0;
	int boss_font_img = 0;
	int cursor_font_img = 0;
	int scroll_font_img = 0;
